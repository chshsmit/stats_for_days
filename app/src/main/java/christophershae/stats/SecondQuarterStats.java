...
public class SecondQuarterStats extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.second_quarter_stats, container, false);
...
//    ---------------------------------------------------------------------------------------------------
    ...
    private class MyAdapter extends ArrayAdapter<ListElement> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            minutes.setText(String.format("%d",w.player.secondQuarterStats.get("MINUTES")));

            TextView fieldGoals = (TextView) newView.findViewById(R.id.playersFieldGoals);
            fieldGoals.setText(String.format("%d",w.player.secondQuarterStats.get("2PM") + w.player.secondQuarterStats.get("3PM"))+"-"+String.format("%d",w.player.secondQuarterStats.get("2PA") + w.player.secondQuarterStats.get("3PA")));

            TextView threePointFieldGoals = (TextView) newView.findViewById(R.id.playersThreePointFieldGoals);
            threePointFieldGoals.setText(String.format("%d",w.player.secondQuarterStats.get("3PM"))+"-"+String.format("%d",w.player.secondQuarterStats.get("3PA")));

            TextView freeThrows = (TextView) newView.findViewById(R.id.playersFreeThrows);
            freeThrows.setText(String.format("%d",w.player.secondQuarterStats.get("FTM"))+"-"+String.format("%d",w.player.secondQuarterStats.get("FTA")));

            TextView offensiveRebounds = (TextView) newView.findViewById(R.id.playersOffensiveRebounds);
            offensiveRebounds.setText(String.format("%d",w.player.secondQuarterStats.get("OREB")));

            TextView defensiveRebounds = (TextView) newView.findViewById(R.id.playersDefensiveRebounds);
            defensiveRebounds.setText(String.format("%d",w.player.secondQuarterStats.get("DREB")));

            TextView rebounds = (TextView) newView.findViewById(R.id.playersRebounds);
            rebounds.setText(String.format("%d",w.player.secondQuarterStats.get("DREB") + w.player.secondQuarterStats.get("OREB")));

            TextView assists = (TextView) newView.findViewById(R.id.playersAssists);
            assists.setText(String.format("%d",w.player.secondQuarterStats.get("AST")));

            TextView steals = (TextView) newView.findViewById(R.id.playersSteals);
            steals.setText(String.format("%d",w.player.secondQuarterStats.get("STL")));

            TextView blocks = (TextView) newView.findViewById(R.id.playersBlocks);
            blocks.setText(String.format("%d",w.player.secondQuarterStats.get("BLK")));

            TextView turnovers = (TextView) newView.findViewById(R.id.playersTurnovers);
            turnovers.setText(String.format("%d",w.player.secondQuarterStats.get("TO")));

            TextView fouls = (TextView) newView.findViewById(R.id.playersFouls);
            fouls.setText(String.format("%d",w.player.secondQuarterStats.get("FOUL")));

            TextView points = (TextView) newView.findViewById(R.id.playersPoints);
            points.setText(String.format("%d",(w.player.secondQuarterStats.get("2PM") * 2) + (w.player.secondQuarterStats.get("3PM") * 3) + w.player.secondQuarterStats.get("FTM")));
